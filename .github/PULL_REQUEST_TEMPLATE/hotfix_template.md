...
Example:
   - This Hotfix PR fixes a critical downtime error with data connectivity.
-->
...
<!-- Describe the fix implemented details on the hotfix applied
Example:
   - Updated `config.py` to point to the correct database host.
-->


## Testing Instructions

<!-- Explain how the hotfix was tested. Provide instructions for reviewers to manually reproduce, validate, or test this PR's changes. 
Example:
